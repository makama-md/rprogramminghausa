...
vec6 = c(1L, 4.5, "BauchiRUG") #if we mix character and numeric then all the values will be converted to character
vec6
class(vec6)
...
vec8= c(TRUE, 1, 5, "Nigeria") # Character given preference
vec8
class(vec8)
...
name <- c("salis","badamasi","abdullahi")
class(name)
sex <- c("M","M","F")
class(sex)
age <- c(27,26,26)
